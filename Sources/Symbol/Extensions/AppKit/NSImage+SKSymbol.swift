...
public extension NSImage {
    ...
    convenience init(symbol: SKSymbol, accessibilityDescription description: String? = nil) {
    ...
    convenience init(symbol: SKSymbol, variableValue value: Double, accessibilityDescription description: String?) {
