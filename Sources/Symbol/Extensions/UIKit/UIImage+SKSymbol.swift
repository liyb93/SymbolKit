...
public extension UIImage {
    ...
    convenience init(symbol: SKSymbol) {
    ...
    convenience init(symbol: SKSymbol, compatibleWith traitCollection: UITraitCollection?) {
    ...
    convenience init(symbol: SKSymbol, withConfiguration configuration: UIImage.Configuration?) {
    ...
    convenience init(symbol: SKSymbol, variableValue: Double, configuration: UIImage.Configuration?) {
        self.init(systemName: symbol.rawValue, variableValue: variableValue, configuration: configuration)!
    }
}
